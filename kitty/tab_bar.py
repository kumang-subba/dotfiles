...
bg_color_bat = as_rgb(color_as_int(opts.color0))
...
def _draw_right_status(screen: Screen, is_last: bool, cells: list) -> int:
    ...
    screen.cursor.fg = 0
    for color, status, bg_color, separator_needed in cells:
...
def draw_tab(
    ...
    cells.append((clock_color, TIME_ICON, bg_color_time, True))
    cells.append((clock_color, clock, bg_color_time, False))
    cells.append((date_color, DATE_ICON, bg_color_date, True))
    cells.append((date_color, date, bg_color_date, False))
